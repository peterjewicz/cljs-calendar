...
goog.provide('cal_test.core');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('module$Applications$server$cal_test$node_modules$moment$moment');
cal_test.core.check_false_on_month = (function cal_test$core$check_false_on_month(date){
...
cal_test.core.get_current_month_days = (function cal_test$core$get_current_month_days(currentMonth){
return module$Applications$server$cal_test$node_modules$moment$moment["default"](currentMonth,"MM").daysInMonth("YYYY-MM");
});
cal_test.core.get_day_display = (function cal_test$core$get_day_display(offsetAmount,numberOfDays,currentCount){
...
cal_test.core.generate_table_row = (function cal_test$core$generate_table_row(offsetAmount,numberOfDays,i,currentMonth,currentYear,date_values){
...
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cal_test.core.check_false_on_month.call(null,currentMonth)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(((i + x) - offsetAmount)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(currentYear)].join('')]),date_values);
}
})())){
var G__1457 = (x + (1));
var G__1458 = cljs.core.conj.call(null,row,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.active","td.active",1072089856),cal_test.core.get_day_display.call(null,offsetAmount,numberOfDays,(i + x))], null));
x = G__1457;
row = G__1458;
continue;
} else {
var G__1459 = (x + (1));
var G__1460 = cljs.core.conj.call(null,row,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),cal_test.core.get_day_display.call(null,offsetAmount,numberOfDays,(i + x))], null));
x = G__1459;
row = G__1460;
continue;
}
...
cal_test.core.generate_table_html = (function cal_test$core$generate_table_html(numberOfDays,currentMonth,currentYear,date_values){
...
var G__1461 = (i + (7));
var G__1462 = cljs.core.conj.call(null,html,cal_test.core.generate_table_row.call(null,offsetAmount,numberOfDays,i,currentMonth,currentYear,date_values));
i = G__1461;
html = G__1462;
continue;
}
...
cal_test.core.increment_year = (function cal_test$core$increment_year(currentYear){
return (parseInt(currentYear) + (1));
});
cal_test.core.deincrement_year = (function cal_test$core$deincrement_year(currentYear){
return (parseInt(currentYear) - (1));
});
cal_test.core.increment_month = (function cal_test$core$increment_month(current,currentYear,monthDays){
if(cljs.core._EQ_.call(null,current,(12))){
cljs.core.reset_BANG_.call(null,monthDays,cal_test.core.get_current_month_days.call(null,(1)));

cljs.core.swap_BANG_.call(null,currentYear,(function (current__$1){
return cal_test.core.increment_year.call(null,current__$1);
}));

return (1);
} else {
cljs.core.reset_BANG_.call(null,monthDays,cal_test.core.get_current_month_days.call(null,(parseInt(current) + (1))));

return (parseInt(current) + (1));
}
});
cal_test.core.deincrement_month = (function cal_test$core$deincrement_month(current,currentYear,monthDays){
if(cljs.core._EQ_.call(null,current,(1))){
cljs.core.reset_BANG_.call(null,monthDays,cal_test.core.get_current_month_days.call(null,(12)));

cljs.core.swap_BANG_.call(null,currentYear,(function (current__$1){
return cal_test.core.deincrement_year.call(null,current__$1);
}));
...
cal_test.core.render = (function cal_test$core$render(dates){
...
var monthDays = reagent.core.atom.call(null,cal_test.core.get_current_month_days.call(null,cljs.core.deref.call(null,currentMonth)));
...
return cal_test.core.deincrement_month.call(null,current,currentYear__$1,monthDays);
