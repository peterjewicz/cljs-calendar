...
var G__10684 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10684,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10684;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10686){
var G__10687 = cljs.core.first.call(null,seq10686);
var seq10686__$1 = cljs.core.next.call(null,seq10686);
var G__10688 = cljs.core.first.call(null,seq10686__$1);
var seq10686__$2 = cljs.core.next.call(null,seq10686__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10687,G__10688,seq10686__$2);
});
...
var file = cljs.core.get.call(null,map__10693__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10693__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10693__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10693,map__10693__$1,file,line,column){
return (function (p1__10692_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10692_SHARP_));
});})(map__10693,map__10693__$1,file,line,column))
...
var temp__5457__auto___10695 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10695)){
var message_10696 = temp__5457__auto___10695;
cljs.core.println.call(null,message_10696);
} else {
}
...
var temp__5457__auto___10697 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10697)){
var message_10698 = temp__5457__auto___10697;
cljs.core.println.call(null,message_10698);
} else {
}
...
var output_dir__$1 = (function (){var G__10699 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10699),"/"].join('');
} else {
return G__10699;
}
})();
...
var G__10701 = exception.stack;
var G__10701__$1 = (((G__10701 == null))?null:clojure.string.split_lines.call(null,G__10701));
var G__10701__$2 = (((G__10701__$1 == null))?null:cljs.core.get.call(null,G__10701__$1,depth));
if((G__10701__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10701__$2);
}
} else {
...
var vec__10702 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10702,(0),null);
var column = cljs.core.nth.call(null,vec__10702,(1),null);
var vec__10705 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10705,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10705,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10705,(2),null);
...
var m__$1 = (function (){var G__10708 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10712 = (function (){var G__10711 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10711);
} else {
return G__10711;
}
})();
...
return cljs.core.vary_meta.call(null,G__10713,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10714){var e = e10714;
var G__10715 = e;
var G__10715__$1 = (((G__10715 instanceof cljs.core.Keyword))?G__10715.fqn:null);
switch (G__10715__$1) {
...
var vec__10717 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10717,(0),null);
var types = vec__10717;
...
var ns = cljs.core.nth.call(null,vec__10721,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10721,(1),null);
return ((function (vec__10721,ns,vars__$1){
return (function (){
...
var G__10724 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1){
return (function (){
var seq__10725 = cljs.core.seq.call(null,vars__$1);
var chunk__10726 = null;
var count__10727 = (0);
var i__10728 = (0);
while(true){
if((i__10728 < count__10727)){
var v = cljs.core._nth.call(null,chunk__10726,i__10728);
var temp__5457__auto___10730 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10730)){
var t_10731 = temp__5457__auto___10730;
each_fixture_fn.call(null,((function (seq__10725,chunk__10726,count__10727,i__10728,t_10731,temp__5457__auto___10730,v,each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10731)));
});})(seq__10725,chunk__10726,count__10727,i__10728,t_10731,temp__5457__auto___10730,v,each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1))
);
} else {
}


var G__10732 = seq__10725;
var G__10733 = chunk__10726;
var G__10734 = count__10727;
var G__10735 = (i__10728 + (1));
seq__10725 = G__10732;
chunk__10726 = G__10733;
count__10727 = G__10734;
i__10728 = G__10735;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10725);
if(temp__5457__auto__){
var seq__10725__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10725__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__10725__$1);
var G__10736 = cljs.core.chunk_rest.call(null,seq__10725__$1);
var G__10737 = c__4351__auto__;
var G__10738 = cljs.core.count.call(null,c__4351__auto__);
var G__10739 = (0);
seq__10725 = G__10736;
chunk__10726 = G__10737;
count__10727 = G__10738;
i__10728 = G__10739;
continue;
} else {
var v = cljs.core.first.call(null,seq__10725__$1);
var temp__5457__auto___10740__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10740__$1)){
var t_10741 = temp__5457__auto___10740__$1;
each_fixture_fn.call(null,((function (seq__10725,chunk__10726,count__10727,i__10728,t_10741,temp__5457__auto___10740__$1,v,seq__10725__$1,temp__5457__auto__,each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10741)));
});})(seq__10725,chunk__10726,count__10727,i__10728,t_10741,temp__5457__auto___10740__$1,v,seq__10725__$1,temp__5457__auto__,each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1))
);
} else {
}


var G__10742 = cljs.core.next.call(null,seq__10725__$1);
var G__10743 = null;
var G__10744 = (0);
var G__10745 = (0);
seq__10725 = G__10742;
chunk__10726 = G__10743;
count__10727 = G__10744;
i__10728 = G__10745;
continue;
}
} else {
...
});})(each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1))
);
});})(each_fixture_fn,G__10724,G__10724__$1,env,once_fixtures,each_fixtures,vec__10721,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10724__$1)].join('')));

}
})());
});
;})(vec__10721,ns,vars__$1))
