...
var G__11271 = o;
(G__11271[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11275 = o;
(G__11275[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__11276__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__11276 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11277__i = 0, G__11277__a = new Array(arguments.length -  0);
while (G__11277__i < G__11277__a.length) {G__11277__a[G__11277__i] = arguments[G__11277__i + 0]; ++G__11277__i;}
  args = new cljs.core.IndexedSeq(G__11277__a,0,null);
} 
return G__11276__delegate.call(this,args);};
G__11276.cljs$lang$maxFixedArity = 0;
G__11276.cljs$lang$applyTo = (function (arglist__11278){
...
var G__11280 = props;
var G__11280__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11280,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11280);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11280__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11281){
...
var props = map__11282__$1;
var class$ = cljs.core.get.call(null,map__11282__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__11282,map__11282__$1,props,class$){
return (function (c){
...
});})(map__11282,map__11282__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11284){
...
var on_write = cljs.core.get.call(null,map__11285__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11285,map__11285__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11285,map__11285__$1,on_write))
);
} else {
...
var G__11288 = jsprops;
(G__11288["defaultValue"] = value);

(G__11288["onChange"] = ((function (G__11288,v,value,on_change){
return (function (p1__11287_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11287_SHARP_);
});})(G__11288,v,value,on_change))
);
...
var vec__11291 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11291,(0),null);
var id = cljs.core.nth.call(null,vec__11291,(1),null);
var class$ = cljs.core.nth.call(null,vec__11291,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___11295 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___11295 == null)){
} else {
var key_11296 = temp__5461__auto___11295;
(jsprops["key"] = key_11296);
}
...
var temp__5461__auto___11297 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___11297 == null)){
} else {
var key_11298 = temp__5461__auto___11297;
reagent.impl.template.oset.call(null,jsprops,"key",key_11298);
}
...
var G__11299 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__11299["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11302){
var G__11303 = cljs.core.first.call(null,seq11302);
var seq11302__$1 = cljs.core.next.call(null,seq11302);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11303,seq11302__$1);
});
...
break;
default:
var G__11309 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11309;
continue;
...
var n__4408__auto___11311 = a.length;
var i_11312 = (0);
while(true){
if((i_11312 < n__4408__auto___11311)){
(a[i_11312] = reagent.impl.template.as_element.call(null,(a[i_11312])));

var G__11313 = (i_11312 + (1));
i_11312 = G__11313;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___11314 = a.length;
var i_11315 = (0);
while(true){
if((i_11315 < n__4408__auto___11314)){
var val_11316 = (a[i_11315]);
if(((cljs.core.vector_QMARK_.call(null,val_11316)) && ((reagent.impl.template.key_from_vec.call(null,val_11316) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11315] = reagent.impl.template.as_element.call(null,val_11316));
...
var ctx = ({});
var vec__11318 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11318,(0),null);
var derefed = cljs.core.nth.call(null,vec__11318,(1),null);
...
var G__11321 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11321) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11321){
